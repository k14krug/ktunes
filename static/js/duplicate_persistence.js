...
class DuplicatePersistenceManager {
    ...
    displayAgeBanner(ageData) {
        ...
        const ageText = $('#analysisAgeText');
        const timestamp = $('#analysisTimestamp');
        
        // Set age text and timestamp
        ageText.text(ageData.age_info.relative_age);
        timestamp.text(`(Created: ${ageData.age_info.formatted_timestamp})`);
        ...
        ageText.prepend(stalenessIndicator);
